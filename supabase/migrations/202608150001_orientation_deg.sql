-- AcoustiField: orientation de l'enregistreur (degrés, boussole).
-- À appliquer APRÈS 202608150000_habitat_autre.sql.

alter table public.fiches add column if not exists orientation_deg double precision;
